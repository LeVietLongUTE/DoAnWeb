        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a onclick="return confirm('Bạn có chắc muốn xóa sản phẩm này hay không?')" href="{{URL::to('/delete-product/'.$product->product_id)}}" style="font-size: 20px" class="active ui-toggle-class="" >
