        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a onclick="return confirm('Bạn có chắc muốn xóa háo đơn này hay không?')" href="{{URL::to('/list-bill/delete-don-hang/'.$item->id)}}" style="font-size: 20px" class="active ui-toggle-class="" >
